...
if __name__ == "__main__":
    ...
    # turb_coords   =  getTurbLoc('Shell_Hackathon Dataset/Shell_Hackathon Dataset/turbine_loc_test.csv')
    turb_coords   =  getTurbLoc('Wind Farm Evaluator/my_trials/random_test.csv')
    # Load the power curve
    power_curve   =  loadPowerCurve('Shell_Hackathon Dataset/Shell_Hackathon Dataset/power_curve.csv')
    
    # Pass wind data csv file location to function binWindResourceData.
    # Retrieve probabilities of wind instance occurence.
    wind_inst_freq =  binWindResourceData('Shell_Hackathon Dataset/Shell_Hackathon Dataset/Wind Data/wind_data_2007.csv')   
